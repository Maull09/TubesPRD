...
matkul = ttk.Label(canvas, text="PRD", font=("Helvetica", 40, "bold"))
kelas = ttk.Label(canvas, text="K69", font=("Helvetica", 40, "bold"))
...
canvas.create_window(720, 300, window = matkul)
canvas.create_window(720, 400, window = kelas)
canvas.create_window(520, 600, window = nama)
canvas.create_window(520, 650, window = nim)
canvas.create_window(520, 700, window = status)
